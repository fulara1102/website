...
def time(request):
    return HttpResponse("<h1> Please wait for 1 hour </h1>")


def report(request):
    return HttpResponse("<h2> We are fetcing your report ! Please co-operate with us</h2>")
    
    
def history(request):
    return HttpResponse("<h2> Your history is fetching.Please wait.</h2>")
